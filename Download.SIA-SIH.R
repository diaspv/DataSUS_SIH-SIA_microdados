#Download de arquivos SIA/SUS e SIH/SUS
...
AA <- select.list(stringr::str_pad(seq(8, format(Sys.Date(), "%y")), 2, pad = "0"), title="Selecione o(s) ano(s):", graphics = TRUE, multiple=TRUE)
